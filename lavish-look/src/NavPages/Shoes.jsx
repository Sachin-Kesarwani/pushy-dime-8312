...
import ShoesCard from "../EachCard/ShoesCard"
...
async function  getMensdata(page){
    setLoading(true)
    try {
        let res=await fetch(`https://63ca8992f36cbbdfc75aa2e5.mockapi.io/shoes?page=${page}&limit=9`)
...
function width(){
    ...
    return Loading?<Loadingindicator/>:(
        <>
       <Heading as="h2"   fontFamily={"Brush Script MT, Brush Script Std, cursive"}>Shoes Section</Heading>
        ...
        <Box  style={{width:"90%",margin:"auto",display:"grid",gridTemplateColumns:`repeat(${col},1fr)`}} >
        {
                menspro.map((e)=>{
                    return <div >
                        ...
                        < ShoesCard  addTocart ={addTocart} {...e} />
